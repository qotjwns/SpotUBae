...
class MyRoutineScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          const Text("My Routine", style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
          ...
          child: Row(
            ...
            children: [
              TextButton.icon(
                ...
                label: const Text("Add workout", style: TextStyle(fontSize: 20, color: Colors.black)),
              ...
              ElevatedButton(
                ...
                child: const Text("Finish", style: TextStyle(fontSize: 20, color: Colors.white)),
                style: ElevatedButton.styleFrom(
  ...
  Row setsRepsKgRow() {
    return const Row(
      children: [
        SizedBox(width: 45,),
        Text("Sets", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
        SizedBox(width: 80,),
        Text("Reps", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
        SizedBox(width: 80,),
